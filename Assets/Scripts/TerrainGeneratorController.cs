...
public class TerrainGeneratorController : MonoBehaviour
{
    ...
    private void GenerateTerrain(float lastGeneratedPositionX, float terrain)
    {
    ...
    {
        GameObject newTerrain = Instantiate(terrainTemplates[UnityEngine.Random.Range(0, terrainTemplates.Count)].gameObject, transform);
